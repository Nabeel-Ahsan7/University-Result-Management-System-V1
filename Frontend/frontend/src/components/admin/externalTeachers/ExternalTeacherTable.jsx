...
export default function ExternalTeacherTable({ externalTeachers, onEdit, onDelete, onView, loading }) {
                            ...
                            externalTeachers
                                ...
                                .map((teacher) => (
                                    <TableRow key={teacher._id} hover>
                                        ...
                                        <TableCell>{teacher.university_name}</TableCell>
