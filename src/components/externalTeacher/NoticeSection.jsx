...
const NoticeSection = () => {
    ...
    const fetchNotices = async () => {
        try {
            ...
            // Step 1: Get all exam committees the external teacher is part of
            const [internalResponse, externalResponse] = await externalTeacherService.getAllAssignedExams();
            ...
            const noticesResponse = await externalTeacherService.getCommitteeNotices(committeeIds);
